...
function LandingPage() {
  ...
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.3" className='w-full h-screen bg-zinc-900 pt-1'>
              ...
              <div className="w-fit flex items-center overflow-hidden">
                {index === 2 && (
                  <motion.div
                    ...
                    className="mr-[1vw] mt-[5px] w-[10vw] h-[5vw] bg-red-500 rounded-md  sm:block"
                  ></motion.div>
                )}
                <h1 className="uppercase text-[7vw] sm:text-[5vw] lg:text-[4vw] leading-[8vw] sm:leading-[5vw] lg:leading-[4vw] tracking-tighter font-medium text-left min-h-[40px]">
                  {item}
                </h1>
              </div>
            </div>
      ...
      <div className="hidden md:flex border-t-2 border-zinc-700 mt-30 justify-between items-center py-5 px-20">
        ...
        <div className="start flex items-center gap-5 text-sm uppercase">
          <div className="relative px-5 py-2 border-[2px] border-zinc-500 rounded-full cursor-pointer overflow-hidden group">
            ...
            <a href='https://github.com/VivekJadhav2001' target='_blank'>
              <span className="relative z-10 text-white group-hover:text-black">GitHub</span>
            </a>
          </div>
